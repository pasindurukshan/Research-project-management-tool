...
export default class requestCoSupervisor extends Component {
  ...
  validate = () => {
    ...
    if (!this.state.reseachTopic) {
      reseachTopicError = "* Reseach Topic is Required!"
    }
    if (!this.state.reseachFeild) {
      reseachFeildError = "* Reseach Feild  is Required"
    }
    if (!this.state.description) {
      descriptionError = "* Description is Required"
    }
    if (!this.state.supervisor) {
      supervisorError = "* Supervisor Name is Required"
    }
    if (!this.state.supervisorEmail) {
      supervisorEmailError = "* Supervisor Email is Required"
    }
  ...
  onSubmit = (e) => {
    ...
    if (isValid) {
      ...
      //backend url called
      debugger
      axios.post("http://localhost:4000/api/v1/editor/requestcosupervisor", data).then((res) => {
      ...
      <div className="container">
        <div className="col-md-6 mt-5 mx-auto">
          ...
          <div class="p-3 mb-2 bg-light text-dark rounded-3">
            <h2 className="h3 mb-3 front-weight-normal">Request Co-Supervisor </h2>
            <form className="needs-validation" noValidate>
              ...
              <div class="form-row">
                <div className="form-group" style={{ marginBottom: '15px' }}>
                  <label style={{ marginBottom: '5px' }}>Supervisor Name</label>
                  <input type="text"
                    className="form-control"
                    name="supervisor"
                ...
                &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;
                <div className="form-group" style={{ marginBottom: '15px' }}>
                  <label style={{ marginBottom: '5px' }}>Supervisor Email</label>
                  <input type="text"
                    className="form-control"
                  ...
                  <div style={{ fontSize: 12, color: "red" }}>
                    {this.state.supervisorEmailError}
                  </div>
